...
while True:
    ...
    # object *detectors* to obtain a higher frame processing throughput
        ...
        for tracker in trackers:
            ...
            distance = (abs((a * center[0]) + (b * center[1]) + c)) / sqrt((a * a) + (b * b))
            col_l = (y_end - y_start) / (x_end - x_start)
            col_r = (center[1] - y_start) / (center[0] - x_start)
            print('col_l',col_l)
            print('col_r',col_r)
            ...
            print(x_range.count(center[0]))
            print(y_range.count(center[1]))
            print(center[0],center[1])
            if(collinear <= 0.01 and collinear>=-0.02 and x_range.count(center[0]) >= 1 and y_range.count(center[1]) >= 1):
                print(center[0],center[1])
                print('x:',x_range.count(center[0]))
                print('y',y_range.count(center[1]))
                cross_x = cross_x + 1
