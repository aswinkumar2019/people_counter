...
while True:
        ...
        # for _ in range(args.count):
           ...
           # if confidence > args["confidence"]:
            ...
            #    idx = int(detections[0, 0, i, 1])
               ...
               # startX, startY, endX, endY = int(obj.bbox['xmin']),int(obj.bbox['ymin']),int(obj.bbox['xmax']),int(obj.bbox['ymax'])
                print(obj.bbox.xmin,obj.bbox.ymin,obj.bbox.xmax,obj.bbox.ymax)
                #sleep(5)
                startX = int(obj.bbox.xmin)
                startY = int(obj.bbox.ymin)
                endX = int(obj.bbox.xmax)
                endY = int(obj.bbox.ymax)
    ...
    # object *detectors* to obtain a higher frame processing throughput
        ...
        print("in else outside trackers")
